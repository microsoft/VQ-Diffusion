...
class TamingFFHQVQVAE(BaseCodec):
    def __init__(
            ...
            ckpt_path='OUTPUT/pretrained_model/taming_dvae/vqgan_ffhq_f16_1024.ckpt',
            num_tokens=1024,
            quantize_number=0,
            mapping_path=None,
        ):
...
class TamingVQVAE(BaseCodec):
    def __init__(
            ...
            ckpt_path='OUTPUT/pretrained_model/taming_dvae/vqgan_imagenet_f16_16384.ckpt',
            num_tokens=16384,
            quantize_number=974,
...
class TamingGumbelVQVAE(BaseCodec):
    def __init__(
            ...
            ckpt_path='OUTPUT/pretrained_model/taming_dvae/taming_f8_8192_openimages_last.ckpt',
            num_tokens=8192,
